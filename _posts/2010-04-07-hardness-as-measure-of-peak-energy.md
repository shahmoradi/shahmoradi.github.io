...
&nbsp; --  The spectral peak energy (E<sub>P,obs</sub>) estimates for 2130 BATSE GRBs can be downloaded from <a href="https://docs.google.com/spreadsheets/d/1KkAkpMTQoUegQrUu056uXDzByGxMD3wo5g6W2Qdk4q8/edit?usp=sharing" target="_black">here</a>. <br>
&nbsp; --  Conditional E<sub>P,obs</sub> probability density functions for all bursts can be downloaded collectively as a <a href="https://docs.google.com/viewer?a=v&pid=sites&srcid=ZGVmYXVsdGRvbWFpbnxhbXNocG9ydGFsfGd4OjNiMjdhNDhjZWNiZjIzYjE" target="_blank">zip file</a>)
